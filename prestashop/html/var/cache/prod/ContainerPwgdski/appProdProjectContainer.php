    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                56 => ($this->targetDirs[3].'/modules/ps_bestsellers/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_cashondelivery/translations'),
            ]; break;
